<div class="main-content md:flex-1 md:overflow-y-auto relative">
    ...
    <div class="px-4 py-8 md:flex-1 md:p-12 md:overflow-y-auto"
         scroll-region="">
        <div x-data="{organization_name:$wire.form.name}">
            <h1 class="mb-8 text-3xl font-bold"><a class="text-indigo-400 hover:text-indigo-600"
                                                   href="/organizations" wire:navigate>Organizations</a><span
